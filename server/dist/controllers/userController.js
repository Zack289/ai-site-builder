...
export const createUserProject = async (req, res) => {
    ...
    try {
        ...
        await prisma.conversation.create({
            data: {
                role: "assistant",
                content: `I have you enhanced your prompt to: "${enhancedPrompt}"`,
                projectId: project.id,
            },
        });
        await prisma.conversation.create({
        ...
        await prisma.conversation.create({
            data: {
                role: "assistant",
                content: "I have created your website ! You can now preview it now and request any changes",
                projectId: project.id,
            },
        });
        ...
        //if any error occur while creating site, it will increment credits
        await prisma.user.update({
            where: { id: userId },
            data: { credits: { increment: 5 } },
        });
...
// Controller Functions to get all users projects
