            ...
            <div className="flex flex-wrap gap-3.5">
              {projects.map((project) => (
                <Link
                  ...
                  to={`/view/${project.id}`}
                  target="_blank"
                  className="w-72 max-sm:max-auto cursor-pointer bg-gray-900/60 border border-gray-700 rounded-lg overflow-hidden  group hover:border-indigo-800/80 transition-all duration-300"
                >
                  ...
                  <div className="p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors">
                    ...
                    <div className="flex justify-between items-center mt-6">
                      ...
                      <div className="flex gap-3 text-white text-sm">
                        <button className="px-3 py-1.5 bg-white/10 hover:bg-white/15 rounded-md  taransition-colors flex items-center gap-2">
